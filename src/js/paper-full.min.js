...
var paper = function(t, e) {
        ...
        r = new function() {
            function t(t, e, r, s, a) {
                function u(i, u) {
                    ...
                    (a && _) ||
                        ...
                        (o(t, i) || { configurable: !0 }).configurable &&
                            ((d.configurable = !0),
            ...
            var i = /^(statics|enumerable|beans|preserve)$/,
                ...
                f = function(t, e, n) {
                    if (t) {
                        var i = o(t, "length");
                        (i && "number" == typeof i.value ? u : l).call(
                            t,
                            e,
                            (n = n || t)
                        );
            ...
            return t(n, {
                inject: function(e) {
                    if (e) {
                        var n = e.statics === !0 ? e : e.statics,
                            i = e.beans,
                            r = e.preserve;
                        n !== e && t(this.prototype, e, e.enumerable, i, r),
                            t(this, n, null, i, r);
                    }
                ...
                extend: function() {
                    for (
                        var e, n, i, r = this, s = 0, o = arguments.length;
                        s < o && (!e || !n);
                        s++
                    )
                        (i = arguments[s]),
                    ...
                    return (
                        ...
                        (n = e.prototype = n || a(this.prototype)),
                        h(n, "constructor", {
                            value: e,
                            writable: !0,
                            configurable: !0
        ...
        r.inject(
            ...
            },
            {
                ...
                statics: {
                    exports: {},
                    extend: function rt() {
                        var t = rt.base.apply(this, arguments),
                    ...
                    read: function(t, n, i, s) {
                        ...
                        if (
                            ...
                            var f = c.__filtered;
                            f && ((t.__filtered = f), (c.__filtered = e)),
                                (c.__read = e);
                        }
                        return c;
                    },
                    ...
                    getNamed: function(t, n) {
                        ...
                        if (
                            (t._hasObject === e &&
                                (t._hasObject =
                                    1 === t.length && r.isPlainObject(i)),
                            t._hasObject)
                        )
                            return n ? i[n] : t.__filtered || i;
                    },
                    ...
                    serialize: function(t, e, n, i) {
                        ...
                        if (
                            ...
                            for (var u = 0, l = t.length; u < l; u++)
                                s[u] = r.serialize(t[u], e, n, i);
                        } else if (r.isPlainObject(t)) {
                            s = {};
                            for (
                                var c = Object.keys(t), u = 0, l = c.length;
                                u < l;
                                u++
                            ) {
                                var f = c[u];
                    ...
                    deserialize: function(t, e, n, i, s) {
                        ...
                        if (((n = n || {}), Array.isArray(t))) {
                            ...
                            if (1 == t.length && /^#/.test(u))
                                return n.dictionary[u];
                            (u = r.exports[u]), (a = []);
                            for (var c = u ? 1 : 0, f = t.length; c < f; c++)
                                a.push(r.deserialize(t[c], e, n, l, h));
                            if (u) {
                                var d = a;
                                e
                                    ? (a = e(u, d, o || s))
                                    : ((a = r.create(u.prototype)),
                                      u.apply(a, d));
                            }
                        } else if (r.isPlainObject(t)) {
                            (a = {}), i && (n.dictionary = a);
                    ...
                    splice: function(t, n, i, r) {
                        ...
                        n && h.push.apply(h, n);
                        for (
                            var u = t.splice.apply(t, h), o = 0, l = u.length;
                            o < l;
                            o++
                        )
                            u[o]._index = e;
                        for (var o = i + s, l = t.length; o < l; o++)
                            t[o]._index = o;
                        return u;
                    },
            ...
            initialize: function at() {
                ...
                if (!this.agent) {
                    var i = t.navigator.userAgent.toLowerCase(),
                        s = (/(darwin|win|mac|linux|freebsd|sunos)/.exec(i) ||
                            [])[0],
                        a = "darwin" === s ? "mac" : s,
    ...
    var u = new function() {
                ...
                solveCubic: function(e, i, r, h, f, d, _) {
                    ...
                    if (
                        ...
                        var b = w / e,
                            ...
                            I =
                                k > 0
                                    ? 1.324717957244746 * Math.max(C, a(k))
                                    : C,
                            P = v - S * I;
                        if (P !== v) {
                            do g(P), (P = 0 === y ? v : v - w / y / (1 + c));
                            while (S * P > S * v);
                            s(e) * v * v > s(h / v) &&
                                ((m = -h / v), (p = (m - r) / v));
                        }
                    }
                    var A = u.solveQuadratic(e, p, m, f, d, _),
                        M = null == d;
                    return (
                        isFinite(v) &&
                            (0 === A || (A > 0 && v !== f[0] && v !== f[1])) &&
        ...
        c = r.extend(
            {
                ...
                getAngle: function() {
                    return (
                        180 *
                        this.getAngleInRadians.apply(this, arguments) /
                        Math.PI
                    );
                },
                setAngle: function(t) {
            ...
            },
            {
                ...
                rotate: function(t, e) {
                    ...
                    var n = e ? this.subtract(e) : this,
                        ...
                        r = Math.cos(t);
                    return (
                        (n = new c(n.x * r - n.y * i, n.x * i + n.y * r)),
                        e ? n.add(e) : n
                    );
                },
        ...
        g = r.extend(
            {
                ...
                scale: function(t, n) {
                    return this.expand(
                        ...
                        this.height * (n === e ? t : n) - this.height
                    );
                }
            },
            r.each(
        ...
        p = r.extend(
            {
                        ...
                        (n >= 6
                            ...
                            : 1 === n || 2 === n
                              ? t instanceof ot
                                ...
                                : Array.isArray(t)
                                  ? this._set.apply(this, e ? t.concat([e]) : t)
                                  : (i = !1)
                              : n ? (i = !1) : this.reset(),
                        !i)
                    )
                ...
                apply: function(t, e) {
                    ...
                    return (
                        !!n &&
                        (n.transform(null, !0, r.pick(t, !0), e),
                        this.isIdentity())
                    );
                },
                translate: function() {
        ...
        y = o.extend({
            ...
            initialize: function(t) {
                o.call(this, !0),
                    ...
                    (this._view = Z.create(this, t || tt.getCanvas(1, 1))),
            ...
            getActiveLayer: function() {
                return (
                    this._activeLayer || new b({ project: this, insert: !0 })
                );
            },
            ...
            _insertItem: function(t, n, i) {
                return (
                    (n =
                        ...
                        (this._activeLayer ||
                            this._insertItem(e, new b(w.NO_INSERT), !0)
                        ).insertChild(t, n)),
                    i && n.activate && n.activate(),
                    n
                );
            },
            getItems: function(t) {
        ...
        w = r.extend(
            s,
            {
                statics: {
                    extend: function ut(t) {
                        return (
                            t._serializeFields &&
                                (t._serializeFields = r.set(
                                    {},
                                    this.prototype._serializeFields,
                                    t._serializeFields
                                )),
                            ut.base.apply(this, arguments)
                        );
                    },
                    NO_INSERT: { insert: !1 }
                },
            ...
            }(),
            {
                ...
                _initialize: function(t, n) {
                    ...
                    return (
                        ...
                        (this._applyMatrix =
                            this._canApplyMatrix && h.applyMatrix),
                        n && a.translate(n),
                        (a._owner = this),
                        (this._style = new V(o._currentStyle, this, o)),
                        s ||
                        (i && 0 == t.insert) ||
                        (!h.insertItems && (!i || t.insert !== !0))
                            ? this._setProject(o)
                            : ((i && t.parent) || o)._insertItem(e, this, !0),
                        i &&
                            t !== w.NO_INSERT &&
                            this.set(t, {
                                internal: !0,
                ...
                _serialize: function(t, e) {
                    function n(n) {
                        for (var a in n) {
                            ...
                            r.equals(
                                o,
                                "leading" === a ? 1.2 * n.fontSize : n[a]
                            ) || (i[a] = r.serialize(o, t, "data" !== a, e));
                        }
                    }
                    var i = {},
                        s = this;
                    return (
                        n(this._serializeFields),
                        this instanceof x || n(this._style._defaults),
                        [this._class, i]
                    );
                },
                _changed: function(t) {
                    var n = this._symbol,
                        ...
                        r = this._project;
                    8 & t &&
                        (this._bounds = this._position = this._decomposed = this._globalMatrix = e),
                        i && 40 & t && w._clearBoundsCache(i),
                ...
                function(t) {
                    ...
                    (this["get" + e] = function() {
                        ...
                        (this["set" + e] = function(e) {
                            e != this[n] &&
                                ((this[n] = e), this._changed(i[t] || 129));
                        });
                },
                {}
            ),
            {
                ...
                setPosition: function() {
                    this.translate(
                        c.read(arguments).subtract(this.getPosition(!0))
                    );
                },
                getPivot: function() {
                    var t = this._pivot;
            ...
            r.each(
                ...
                },
                {
                    ...
                    _getBounds: function(t, e) {
                        ...
                        return n && n.length
                            ? (w._updateBoundsCache(this, e.cacheItem),
                              w._getBounds(n, t, e))
                            : new g();
                    },
                    ...
                    _getCachedBounds: function(t, e, n) {
                        ...
                        var u = this._getBounds(t || s, e),
                            ...
                            f =
                                u.nonscaling ||
                                (c.hasStroke() && !c.getStrokeScaling());
                        if (a) {
                            o || (this._bounds = o = {});
                            var h = (o[a] = {
                                rect: l.clone(),
                    ...
                    _getStrokeMatrix: function(t, e) {
                        var n = this.getStrokeScaling()
                                ...
                                : e && e.internal
                                  ? this
                                  : this._parent ||
                                    (this._symbol && this._symbol._item),
            ...
            ),
            {
                ...
                getViewMatrix: function() {
                    return this.getGlobalMatrix().prepend(
                        this.getView()._matrix
                    );
                },
            ...
            },
            {
                ...
                clone: function(t) {
                    ...
                    i && n.copyAttributes(this),
                        (i && !a) || n.copyContent(this),
                        i || n.copyAttributes(this),
                        s && n.insertAbove(this);
                    var o = this._name,
                        h = this._parent;
                    if (o && h) {
                        for (var i = h._children, u = o, l = 1; i[o]; )
                            o = u + " " + l++;
                        o !== u && n.setName(o);
                    }
                    return n;
                ...
                rasterize: function(t, n) {
                    ...
                    return (
                        u.transform(
                            new p().translate(a.add(h.divide(2))).scale(1 / s)
                        ),
                        (n === e || n) && u.insertAbove(this),
                        u
                    );
                },
                contains: function() {
            ...
            new function() {
                ...
                return (
                    y.inject({ hitTest: t, hitTestAll: e, _hitTest: n }),
            ...
            }(),
            {
                _hitTest: function(t, e, n) {
                    ...
                    function s(e, n) {
                        ...
                        if (t.subtract(i).divide(u).length <= 1)
                            return new P(e, g, {
                ...
                matches: function(t, e) {
                    ...
                    var a = /^(empty|editable)$/.test(t)
                        ...
                        : "type" === t ? r.hyphenate(this._class) : this[t];
                    if ("class" === t) {
                ...
                getItem: function(t) {
                    return (
                        w._getItems(this, t, this._matrix, null, !0)[0] || null
                    );
                },
                statics: {
                        ...
                        for (var d = 0, _ = c && c.length; d < _; d++) {
                            ...
                            if (l) {
                                ...
                                l.contains(u) ||
                                    (i.overlapping &&
                                        (u.contains(l) ||
                                            i.path.intersects(v, m))) ||
                                    (y = !1);
                            }
                            if (y && v.matches(e) && (f.push(v), s)) break;
                            if (
                                (i.recursive !== !1 && ct(v, e, m, i, s),
                                s && f.length > 0)
                            )
                                break;
                        }
            ...
            },
            {
                ...
                _insertAt: function(t, e) {
                    ...
                    return (
                        i &&
                            (i._remove(!1, !0), n._insertItem(t._index + e, i)),
                        i
                    );
                },
                ...
                removeChildren: function(t, e) {
                    ...
                    for (
                        var n = r.splice(this._children, null, t, e - t),
                            i = n.length - 1;
                        i >= 0;
                        i--
                    )
                ...
                function(t) {
                    ...
                    this[t] = function() {
                        var n = (e ? r : c).read(arguments),
                            i = c.read(arguments, 0, { readNull: !0 });
                        return this.transform(
                            new p()[t](n, i || this.getPosition(!0))
                        );
                    };
                },
                {
                    ...
                    parentToLocal: function() {
                        return this._matrix._inverseTransform(
                            c.read(arguments)
                        );
                    },
                ...
                _setStyles: function(t, e, n) {
                    ...
                    if (i.hasShadow()) {
                        var l = e.pixelRatio || 1,
                            f = n._shiftless().prepend(new p().scale(l, l)),
                            d = f.transform(new c(i.getShadowBlur(), 0)),
                    ...
                    if (this._visible && 0 !== this._opacity) {
                        ...
                        if (o.isInvertible()) {
                            ...
                            if (
                                (g
                                    ? ((t.globalAlpha = f),
                                      _ && (t.globalCompositeOperation = c))
        ...
        x = w.extend({
            ...
            _getBounds: function dt(t, e) {
                ...
                return n
                    ? n._getCachedBounds(
                          t && t.appended(n._matrix),
                          r.set({}, e, { stroke: !1 })
                      )
                    : dt.base.call(this, t, e);
            },
        ...
        C = w.extend(
            {
                ...
                setSize: function() {
                    ...
                    if (this._size) {
                        if (!this._size.equals(t)) {
                            ...
                            "rectangle" === e
                                ? this._radius.set(
                                      d.min(this._radius, t.divide(2))
                                  )
                                : "circle" === e
                                  ? ((n = i = (n + i) / 2),
                                    (this._radius = n / 2))
                                  : "ellipse" === e &&
                                    this._radius._set(n / 2, i / 2),
                                this._size._set(n, i),
                                this._changed(9);
                        }
                ...
                toPath: function(t) {
                    ...
                    return (
                        ...
                        paper.settings.applyMatrix && n.setApplyMatrix(!0),
                        (t === e || t) && n.insertAbove(this),
                        n
                    );
                },
                toShape: "#clone",
                            ...
                            ? t instanceof O
                              ...
                              : "object" == typeof t &&
                                ("width" in t
                                    ? (e = new g(t))
                                    : "x" in t &&
                                      (e = new g(t.x - 0.5, t.y - 0.5, 1, 1)))
                            : (e = this.getBounds()),
                        !e)
                    )
                        return null;
                    var i = 32,
                        s = Math.min(e.width, i),
                        a = Math.min(e.height, i),
                        o = S._sampleContext;
                    o
                        ? o.clearRect(0, 0, i + 1, i + 1)
                        : (o = S._sampleContext = tt.getContext(new d(i))),
                        o.save();
                    var h = new p()
                        .scale(s / e.width, a / e.height)
                        .translate(-e.x, -e.y);
                    h.applyToContext(o),
                        n && n.draw(o, new r({ clip: !0, matrices: [h] })),
                        this._matrix.applyToContext(o);
                    var u = this.getElement(),
                        l = this._size;
                    u && o.drawImage(u, -l.width / 2, -l.height / 2),
                        o.restore();
                    for (
                        var c = o.getImageData(
                                0.5,
                                0.5,
                                Math.ceil(s),
                                Math.ceil(a)
        ...
        k = w.extend({
            ...
            initialize: function(t, n) {
                this._initialize(t, n !== e && c.read(arguments, 1)) ||
        ...
        A = r.extend({
            ...
            setSelection: function(t) {
                ...
                (this._selection = t = t || 0),
                    n &&
                        t !== e &&
                        (n._updateSelection(this, e, t), n._changed(129));
            },
            _changeSelection: function(t, e) {
                var n = this._selection;
                this.setSelection(e ? n | t : n & ~t);
                ...
                if (s && "catmull-rom" !== s) {
                    ...
                    if (o && h) {
                        var g = u.subtract(f),
                            v = a === e ? 0.4 : a,
                            p = v * d / (d + _);
                        n || this.setHandleIn(g.multiply(p)),
                    ...
                    if (!n && o) {
                        ...
                        this.setHandleIn(
                            0 !== S
                                ? new c(
                                      (b * u._x + C * l._x - w * f._x) / S -
                                          l._x,
                                      (b * u._y + C * l._y - w * f._y) / S -
                                          l._y
                                  )
                                : new c()
                        );
                    ...
                    if (!i && h) {
                        ...
                        this.setHandleOut(
                            0 !== S
                                ? new c(
                                      (w * f._x + C * l._x - b * u._x) / S -
                                          l._x,
                                      (w * f._y + C * l._y - b * u._y) / S -
                                          l._y
                                  )
                                : new c()
                        );
        ...
        M = c.extend({
            initialize: function(t, n, i) {
                ...
                if (t)
                    if ((r = t[0]) !== e) s = t[1];
                        ...
                        var o = t;
                        (r = o.x) === e && ((o = c.read(arguments)), (r = o.x)),
                            (s = o.y),
                            (a = o.selected);
                    }
                else r = s = 0;
            ...
            _getSelection: function() {
                ...
                return this === t._point
                    ? 1
                    : this === t._handleIn ? 2 : this === t._handleOut ? 4 : 0;
            }
        }),
        T = r.extend(
            {
                            ...
                            : 2 === _
                              ...
                              : 4 === _
                                ...
                                : 8 === _ &&
                                  ...
                                  (d = [r - a, s - o]))
                          : ((h = new A()), (u = new A())),
                        (this._segment1 = h || new A(l, null, f)),
                        (this._segment2 = u || new A(c, d, null));
                },
                _serialize: function(t, e) {
                    return r.serialize(
                        this.hasHandles()
                ...
                isLast: function() {
                    var t = this._path;
                    return (
                        (t && this._segment1._index === t._curves.length - 1) ||
                        !1
                    );
                },
                isSelected: function() {
            ...
            },
            {
                ...
                divideAtTime: function(t, e) {
                    var n = 1e-8,
                        ...
                        r = null;
                    if (t >= n && t <= i) {
                        var s = T.subdivide(this.getValues(), t),
                            a = s[0],
                            o = s[1],
                            h = e || this.hasHandles(),
                            u = this._segment1,
                            ...
                            f = this._path;
                        h &&
                            (u._handleOut._set(a[2] - a[0], a[3] - a[1]),
                            l._handleIn._set(o[4] - o[6], o[5] - o[7]));
                        var d = a[6],
                            _ = a[7],
                            g = new A(
                                new c(d, _),
                        ...
                        f
                            ? (f.insert(u._index + 1, g), (r = this.getNext()))
                            : ((this._segment2 = g),
                              this._changed(),
                              (r = new T(g, l)));
                    }
                ...
                statics: {
                    ...
                    getTimeOf: function(t, e) {
                        var n = new c(t[0], t[1]),
                            ...
                            a = e.isClose(n, r)
                                ? 0
                                : e.isClose(i, r) ? 1 : null;
                        if (null === a)
                            for (var o = [e.x, e.y], h = [], u = 0; u < 2; u++)
                                for (
                                    var l = T.solveCubic(t, u, o[u], h, 0, 1),
                                        f = 0;
                                    f < l;
                                    f++
                                ) {
                                    var d = h[f];
                                    if (e.isClose(T.getPoint(t, d), s))
                                        return d;
                                }
                    ...
                    getNearestTime: function(t, e) {
                        ...
                        if (T.isStraight(t)) {
                            ...
                            return l < 1e-12
                                ...
                                : l > 0.999999999999
                                  ? 1
                                  : T.getTimeOf(t, new c(i + l * o, r + l * h));
                        }
                        for (var f = 100, d = 1 / 0, _ = 0, g = 0; g <= f; g++)
                            n(g / f);
                        for (var v = 1 / (2 * f); v > 1e-8; )
                            n(_ - v) || n(_ + v) || (v /= 2);
                        return _;
                    },
                    getPart: function(t, e, n) {
                        ...
                        return (
                            e > 0 && (t = T.subdivide(t, e)[1]),
                            n < 1 && (t = T.subdivide(t, (n - e) / (1 - e))[0]),
                            i
                                ? [
                                      t[6],
                                      t[7],
                    ...
                    isStraight: function(t, e, n, i) {
                        ...
                        if (r.isCollinear(e) && r.isCollinear(n)) {
                            var s = new m(t, i),
                                a = 1e-7;
                            if (
                                s.getDistance(t.add(e)) < a &&
                                s.getDistance(i.add(n)) < a
                            ) {
                                var o = r.dot(r),
                                    h = r.dot(e) / o,
                                    u = r.dot(n) / o;
            ...
            ),
            {
                ...
                getLocationOf: function() {
                    return this.getLocationAtTime(
                        this.getTimeOf(c.read(arguments))
                    );
                },
                    ...
                    statics: {
                        ...
                        getLength: function(i, r, s, a) {
                            if (
                                ...
                                var o = i;
                                s < 1 && ((o = T.subdivide(o, s)[0]), (r /= s)),
                                    r > 0 && (o = T.subdivide(o, r)[1]);
                                var h = o[6] - o[0],
                                    l = o[7] - o[1];
                        ...
                        getTimeAt: function(i, r, s) {
                            function a(t) {
                                return (
                                    (p += u.integrate(d, s, t, n(s, t))),
                                    (s = t),
                                    p - r
                                );
                            }
                            if ((s === e && (s = r < 0 ? 1 : 0), 0 === r))
                                return s;
                            var o = Math.abs,
                                h = 1e-12,
                                l = r > 0,
            ...
            new function() {
                function t(t, e, n, i, r, s, a) {
                    ...
                    if (
                        ...
                        var c = new z(n, i, null, a),
                            f = new z(r, s, null, a);
                        (c._intersection = f),
                            (f._intersection = c),
                            (e && !e(c)) || z.insert(t, c, !0);
                    }
                }
                function e(r, s, a, o, h, u, l, c, f, d, _, g, v) {
                    ...
                    if (
                        (0 === I &&
                            ...
                            0 === N) ||
                        null == (p = i(j, F, M, z)) ||
                        null == (y = i(j.reverse(), F.reverse(), M, z))
                    )
                        return f;
                    var D = d + (_ - d) * p,
                        R = d + (_ - d) * y;
                    if (Math.max(v - g, R - D) < w) {
                    ...
                    } else if (((r = T.getPart(r, p, y)), y - p > 0.8))
                        if (R - D > v - g) {
                            var U = T.subdivide(r, 0.5),
                                q = (D + R) / 2;
                            (f = e(s, U[0], o, a, h, u, !l, c, f, g, v, D, q)),
                                (f = e(
                                    s,
                                    U[1],
                                    o,
                            ...
                            var U = T.subdivide(s, 0.5),
                                V = (g + v) / 2;
                            (f = e(U[0], r, o, a, h, u, !l, c, f, g, V, D, R)),
                                (f = e(
                                    U[1],
                                    r,
                                    o,
                        ...
                        f =
                            v - g >= w
                                ? e(s, r, o, a, h, u, !l, c, f, g, v, D, R)
                                : e(r, s, a, o, h, u, l, c, f, D, R, g, v);
                    return f;
                }
                function n(t, e, n, i) {
                    var r,
                ...
                function d(t, e) {
                    ...
                    var i = Math.abs,
                        ...
                        p = f[7] - g;
                    if (
                        r(_, g, v, p, d[0], d[1], !0) < a &&
                        r(_, g, v, p, d[6], d[7], !0) < a
                    )
                        !u &&
                            r(_, g, v, p, f[2], f[3], !0) < a &&
                            r(_, g, v, p, f[4], f[5], !0) < a &&
                            r(_, g, v, p, d[2], d[3], !0) < a &&
                            r(_, g, v, p, d[4], d[5], !0) < a &&
                            (o = h = u = !0);
                    ...
                    if (2 !== w.length) w = null;
                        ...
                        var P = T.getPart(t, w[0][0], w[1][0]),
                            A = T.getPart(e, w[0][1], w[1][1]);
                        (i(A[2] - P[2]) > a ||
                            i(A[3] - P[3]) > a ||
                            i(A[4] - P[4]) > a ||
                            i(A[5] - P[5]) > a) &&
        ...
        z = r.extend(
            {
                ...
                getCurve: function() {
                    function t(t) {
                        var e = t && t.getCurve();
                        if (e && null != (n._time = e.getTimeOf(n._point)))
                            return n._setCurve(e), e;
                    }
                    var e = this._path,
                        n = this;
                    return (
                    ...
                    if (!n && t instanceof z) {
                        ...
                        if (s === a) {
                            var o = Math.abs,
                                ...
                                c = !e && t._intersection;
                            n =
                                (u < h || (s && o(s.getLength() - u) < h)) &&
                                ((!l && !c) || (l && c && l.equals(c, !0)));
                        }
                    }
                    return n;
                },
                ...
                isCrossing: function() {
                    ...
                    var _ = this.getPoint(),
                        ...
                        v = o
                            ? u.getTangentAtTime(i)
                            : u.getPointAt(g).subtract(_),
                        p = o ? v.negate() : l.getPointAt(-g).subtract(_),
                        m = h
                            ? c.getTangentAtTime(r)
                            : c.getPointAt(g).subtract(_),
                        ...
                        C = m.getAngle();
                    return !!(o
                        ? e(w, b, C) ^ e(x, b, C) && e(w, C, b) ^ e(x, C, b)
                        : e(b, w, x) ^ e(C, w, x) && e(b, x, w) ^ e(C, x, w));
                },
                hasOverlap: function() {
                ...
                function t(t, e, n) {
                    ...
                    for (var r = t.length, s = 0, a = r - 1; s <= a; ) {
                        var o,
                            h = (s + a) >>> 1,
                            u = t[h];
                        if (n && (o = e.equals(u) ? u : i(h, -1) || i(h, 1)))
                            return (
                                e._overlap &&
        ...
        O = w.extend({
            ...
            interpolate: function(t, e, n) {
                ...
                if (!s || !a || s.length !== a.length)
                    throw new Error(
                        "Invalid operands in interpolate() call: " +
                            t +
                            ", " +
                            e
                    );
                var h = o.length,
                    u = a.length;
                if (h < u)
                    for (var l = i ? A : L, c = h; c < u; c++)
                        this.add(new l());
                else
                    h > u &&
                        this[i ? "removeSegments" : "removeChildren"](u, h);
        ...
        L = O.extend(
            {
                ...
                _equals: function(t) {
                    return (
                        ...
                        r.equals(this._segments, t._segments)
                    );
                },
                copyContent: function(t) {
                ...
                _changed: function vt(t) {
                    if ((vt.base.call(this, t), 8 & t)) {
                        if (((this._length = this._area = e), 16 & t))
                            this._version++;
            ...
            },
            {
                ...
                getPathData: function(t, e) {
                    function n(e, n) {
                        if (
                            (e._transformCoordinates(t, g),
                            (i = g[0]),
                            (r = g[1]),
                            v)
                        )
                            p.push("M" + _.pair(i, r)), (v = !1);
                        else if (
                            ((o = g[2]),
                            (u = g[3]),
                            o === i && u === r && l === s && c === a)
                    ...
                    return (
                        this._closed && d > 0 && (n(f[0], !0), p.push("z")),
                        p.join("")
                    );
                },
                isEmpty: function() {
                ...
                _add: function(t, e) {
                    for (
                        ...
                        o._path && (o = t[a] = o.clone()),
                            ...
                            (o._index = e + a),
                            o._selection &&
                                this._updateSelection(o, 0, o._selection);
                    }
                    if (s) n.push.apply(n, t);
                    else {
                        n.splice.apply(n, [e, 0].concat(t));
                        for (var a = e + r, h = n.length; a < h; a++)
                            n[a]._index = a;
                    }
                    if (i) {
                        var u = this._countCurves(),
                            ...
                            f = Math.min(l + r, u);
                        t._curves &&
                            (i.splice.apply(i, [l, 0].concat(t._curves)),
                            (c += t._curves.length));
                        for (var a = c; a < f; a++)
                            i.splice(a, 0, new T(this, null, null));
                ...
                add: function(t) {
                    return arguments.length > 1 && "number" != typeof t
                        ? this._add(A.readList(arguments))
                        : this._add([A.read(arguments)])[0];
                },
                insert: function(t, e) {
                    return arguments.length > 2 && "number" != typeof e
                        ? this._add(A.readList(arguments, 1), t)
                        : this._add([A.read(arguments, 1)], t)[0];
                },
                addSegment: function() {
                ...
                removeSegments: function(t, e, n) {
                    ...
                    for (var u = 0; u < h; u++) {
                        var l = o[u];
                        l._selection &&
                            this._updateSelection(l, l._selection, 0),
                ...
                hasHandles: function() {
                    for (
                        var t = this._segments, e = 0, n = t.length;
                        e < n;
                        e++
                    )
                ...
                flatten: function(t) {
                    for (
                        ...
                        r.push(new A(n[s].curve.slice(0, 2)));
                    !this._closed &&
                        i > 0 &&
                        r.push(new A(n[i - 1].curve.slice(6))),
                        this.setSegments(r);
                },
                simplify: function(t) {
                ...
                smooth: function(t) {
                    ...
                    if (/^(?:asymmetric|continuous)$/.test(s)) {
                        ...
                        for (
                            ...
                            (k = M[x] = N - F),
                                (C = P[x] =
                                    B * w[x]._x + j * w[x + 1]._x - F * C),
                                (S = A[x] =
                                    B * w[x]._y + j * w[x + 1]._y - F * S);
                        }
                        ...
                        for (var x = m, D = v - y, b = l; x <= D; x++, b++) {
                            var R = a[b < 0 ? b + o : b],
                                ...
                                V = z[x] - q._x,
                                U = O[x] - q._y;
                            (u || x < D) && R.setHandleOut(V, U),
                                (u || x > m) && R.setHandleIn(-V, -U);
                        }
                    } else
                        for (var x = l; x <= c; x++)
                            a[x < 0 ? x + o : x].smooth(
                ...
                toShape: function(t) {
                    ...
                    function r(t) {
                        var e = c[t],
                            ...
                            i = e._handleOut,
                            r = n._handleIn,
                            s = 0.5522847498307936;
                        if (i.isOrthogonal(r)) {
                            var a = e._point,
                                o = n._point,
                                h = new m(a, i, !0).intersect(
                                    new m(o, r, !0),
                                    !0
                                );
                            return (
                                h &&
                                u.isZero(
                                    i.getLength() / h.subtract(a).getLength() -
                                        s
                                ) &&
                                u.isZero(
                    ...
                    if (
                        ...
                        i(1)
                            ? ((a = C.Rectangle),
                              (o = new d(s(0, 3), s(0, 1))),
                              (l = c[1]._point.add(c[2]._point).divide(2)))
                            : 8 === c.length &&
                              r(0) &&
                              r(2) &&
                              r(4) &&
                              ...
                              ? ((a = C.Rectangle),
                                (o = new d(s(1, 6), s(0, 3))),
                                (h = o
                                    .subtract(new d(s(0, 7), s(1, 2)))
                                    .divide(2)),
                                (l = c[3]._point.add(c[4]._point).divide(2)))
                              : 4 === c.length &&
                                r(0) &&
                                r(1) &&
                                r(2) &&
                                r(3) &&
                                (u.isZero(s(0, 2) - s(1, 3))
                                    ? ((a = C.Circle), (h = s(0, 2) / 2))
                                    : ((a = C.Ellipse),
                                      (h = new d(s(2, 0) / 2, s(3, 1) / 2))),
                                (l = c[1]._point)),
                        a)
                    ) {
                ...
                _hitTestSelf: function(t, e, n, i) {
                    ...
                    function s(t, n, i) {
                        if (!e.selected || n.isSelected()) {
                            var s = t._point;
                            if ((n !== s && (n = n.add(s)), r(n, x)))
                                return new P(i, g, { segment: t, point: n });
                        }
                    }
                    function a(t, n) {
                        return (
                            ((n || e.segments) && s(t, t._point, "segment")) ||
                            (!n &&
                                e.handles &&
                    ...
                    function h(e) {
                        ...
                        if (
                            ...
                            n
                                ? e.isSmooth() ||
                                  L._addBevelJoin(e, u, k, c, null, i, o, !0)
                                : "square" === l &&
                                  L._addSquareCap(e, l, k, null, i, o, !0),
                            !f.isEmpty())
                        ) {
                            var s;
                            return (
                                f.contains(t) ||
                                ((s = f.getNearestLocation(t)) &&
                                    r(s.getPoint(), w))
                            );
                        }
                    }
                        ...
                        (null !== k &&
                            (k > 0
                                ? ((u = v.getStrokeJoin()),
                                  (l = v.getStrokeCap()),
                                  (c = v.getMiterLimit()),
                                  (x = x.add(L._getStrokePadding(k, i))))
                                : (u = l = "round")),
                        !e.ends || e.segments || y)
                    ) {
                ...
                function t(t, e, n, i) {
                    ...
                    for (
                        ...
                        var c = e[u],
                            f = c._selection;
                        if (
                            (c._transformCoordinates(n, h),
                            (s = h[0]),
                            (a = h[1]),
                            2 & f && r(2),
                            4 & f && r(4),
                            t.fillRect(s - o, a - o, i, i),
                            !(1 & f))
                        ) {
                            var d = t.fillStyle;
                            (t.fillStyle = "#ffffff"),
                                t.fillRect(s - o + 1, a - o + 1, i - 2, i - 2),
                                (t.fillStyle = d);
                        }
                    }
                }
                ...
                return {
                    _draw: function(t, n, i, r) {
                        ...
                        if (
                            ...
                            !o &&
                                (u || l) &&
                                (this._setStyles(t, n, i),
                                u &&
                                    (t.fill(h.getFillRule()),
                                    (t.shadowColor = "rgba(0,0,0,0)")),
                                l))
                        ) {
                            if (f) {
                ...
                return {
                    moveTo: function() {
                        ...
                        1 === t.length && this.removeSegment(0),
                            t.length || this._add([new A(c.read(arguments))]);
                    },
                    moveBy: function() {
                        throw new Error(
                            "moveBy() is unsupported on Path items."
                        );
                    },
                    lineTo: function() {
                    ...
                    cubicCurveTo: function() {
                        ...
                        r.setHandleOut(e.subtract(r._point)),
                            this._add([new A(i, n.subtract(i))]);
                    },
                    ...
                    curveTo: function() {
                        var e = c.read(arguments),
                            n = c.read(arguments),
                            i = r.pick(r.read(arguments), 0.5),
                            s = 1 - i,
                            a = t(this)._point,
                            o = e
                                .subtract(a.multiply(s * s))
                                .subtract(n.multiply(i * i))
                                .divide(2 * i * s);
                        if (o.isNaN())
                            throw new Error(
                    ...
                    arcTo: function() {
                        var e,
                            ...
                            v = r.pick(g, !0);
                        if ("boolean" == typeof v)
                            var y = f.add(_).divide(2),
                                e = y.add(y.subtract(f).rotate(v ? -90 : 90));
                        else if (r.remain(arguments) <= 2)
                            (e = _), (_ = c.read(arguments));
                        else {
                            var w = d.read(arguments),
                                x = u.isZero;
                            if (x(w.width) || x(w.height))
                                return this.lineTo(_);
                            ...
                            (n = new c(P * I / M, -M * k / P)
                                ...
                                (a = new p()
                                    ...
                                    .rotate(b)
                                    .scale(P, M)),
                                (s = a._inverseTransform(f)),
                                (i = s.getDirectedAngle(
                                    a._inverseTransform(_)
                                )),
                                !v && i > 0
                                    ? (i -= 360)
                                    : v && i < 0 && (i += 360);
                        ...
                        if (e) {
                            var N = new m(
                                    f.add(e).divide(2),
                                    e.subtract(f).rotate(90),
                                    !0
                                ),
                                B = new m(
                                    e.add(_).divide(2),
                                    _.subtract(e).rotate(90),
                                    !0
                                ),
                                j = new m(f, _),
                                F = j.getSide(e);
                            ...
                            (s = f.subtract(n)),
                                (i = s.getDirectedAngle(_.subtract(n)));
                            var D = j.getSide(n);
                            0 === D
                                ? (i = F * o(i))
                                : F === D && (i += i < 0 ? 360 : -360);
                        ...
                        for (
                            ...
                            if (
                                ($ < V &&
                                    ((G = s.rotate(90).multiply(Z)),
                                    a
                                        ? ((S = a._transformPoint(s)),
                                          (G = a
                                              ._transformPoint(s.add(G))
                                              .subtract(S)))
                                        : (S = n.add(s))),
                                $)
                            ) {
                    ...
                    arcBy: function() {
                        ...
                        "boolean" == typeof i
                            ? this.arcTo(n, i)
                            : this.arcTo(n, e.add(c.read(arguments)));
                    },
            ...
            }(),
            {
                ...
                statics: {
                    getBounds: function(t, e, n, i, r, s) {
                        ...
                        for (
                            var h = new Array(6),
                                u = o._transformCoordinates(i, new Array(6)),
                                l = u.slice(0, 2),
                                c = l.slice(),
                                f = new Array(2),
                                d = 1,
                    ...
                    getStrokeBounds: function(t, e, n, i, r) {
                        ...
                        function o(t, e) {
                            "round" === e || t.isSmooth()
                                ? a(t)
                                : L._addBevelJoin(t, e, p, w, i, f, s);
                        }
                        function h(t, e) {
                            "round" === e
                                ? a(t)
                                : L._addSquareCap(t, e, p, i, f, s);
                        }
                        var u = n.getStyle(),
                            l = u.hasStroke(),
                            c = u.getStrokeWidth(),
                        ...
                        if (h) {
                            ...
                            "miter" === o.getStrokeJoin() &&
                                ...
                                "square" === o.getStrokeCap() &&
                                    (c = Math.max(c, l * Math.SQRT2)),
                                (s = L._getStrokePadding(l, u)),
                                (a = L._getStrokePadding(c, u));
                        }
                        for (
                            var f = new Array(6),
                                d = 1 / 0,
        ...
        statics: new function() {
            ...
            return {
                Line: function() {
                    return t(
                        [
                            new A(c.readNamed(arguments, "from")),
                            new A(c.readNamed(arguments, "to"))
                        ],
                        !1,
                        arguments
                    );
                ...
                Rectangle: function() {
                    var e,
                        i = g.readNamed(arguments, "rectangle"),
                    ...
                    if (!r || r.isZero())
                        e = [new A(s), new A(a), new A(o), new A(h)];
                    else {
                        ...
                        var u = r.width,
                            ...
                            f = l * n;
                        e = [
                            new A(s.add(u, 0), null, [-c, 0]),
                            new A(s.subtract(0, l), [0, f]),
                            new A(a.add(0, l), null, [0, -f]),
                            new A(a.add(u, 0), [-c, 0], null),
                            new A(o.subtract(u, 0), null, [c, 0]),
                            new A(o.add(0, l), [0, -f], null),
                            new A(h.subtract(0, l), null, [0, f]),
                            new A(h.subtract(u, 0), [c, 0])
                        ];
                    }
                ...
                RegularPolygon: function() {
                    for (
                        ...
                        u[l] = new A(e.add(o.rotate((l + h) * s)));
                    return t(u, !0, arguments);
                },
                Star: function() {
                    for (
                        var e = c.readNamed(arguments, "center"),
                            n = 2 * r.readNamed(arguments, "points"),
                            i = r.readNamed(arguments, "radius1"),
                        ...
                        h[u] = new A(
                            e.add(o.rotate(a * u).multiply(u % 2 ? s : i))
                        );
    ...
    var E = O.extend(
        {
            ...
            insertChildren: function yt(t, e) {
                ...
                for (var s = e.length - 1; s >= 0; s--) {
                    var a = n[s];
                    n !== e || a instanceof L || (n = r.slice(n)),
                        Array.isArray(a)
                            ? (n[s] = new L({ segments: a, insert: !1 }))
                            : a instanceof E &&
                              (n.splice.apply(
                                  n,
                                  [s, 1].concat(a.removeChildren())
                              ),
                              a.remove());
                }
        ...
        new function() {
            ...
            function i(e, i, r, a) {
                function o(t) {
                    for (var e = 0, n = t.length; e < n; e++) {
                        var i = t[e];
                        w.push.apply(w, i._segments),
                            x.push.apply(x, i.getCurves()),
                            (i._overlapsOnly = !0);
                    }
                }
                if (
                ...
                (_[r] = !0),
                    c &&
                        (_.subtract || _.exclude) ^
                            (c.isClockwise() ^ u.isClockwise()) &&
                        c.reverse();
                var g,
                    v = l(z.expand(u.getCrossings(c))),
                    m = u._children || [u],
                    y = c && (c._children || [c]),
                    w = [],
                    x = [];
            ...
            function l(t, e, n) {
                ...
                for (var g = t.length - 1; g >= 0; g--) {
                    ...
                    if (
                        ...
                        m._setSegment(p);
                        var k = p._intersection,
                            I = m._intersection;
                        if (k) {
                            a(k, I);
                            for (var P = k; P; )
                                a(P._intersection, k), (P = P._next);
            ...
            function c(t, e, n, i, r) {
                    ...
                    if (!(p < _(a, h) || p > g(a, h))) {
                        ...
                        var C =
                                p === a
                                    ...
                                    : p === h
                                      ? 1
                                      : w > g(f, v, m, b) || x < _(f, v, m, b)
                                        ? 1
                                        : T.solveCubic(s, l, p, M, 0, 1) > 0
                                          ? M[0]
                                          : 1,
                            P =
                                0 === C
                ...
                for (
                    ...
                    if (z + 1 === O || e[z + 1]._path !== N) {
                        if (h && (L = a(h))) return L;
                        !I || S || k || (S = k = N.isClockwise(i) ^ n ? 1 : -1),
                            (b += S),
                            (C += k),
                            (S = k = 0),
                            I && ((P = !0), (I = !1)),
            ...
            function f(t, e, n, i, r) {
                ...
                do {
                    var l = t.getCurve(),
                        f = l.getLength();
                    a.push({ segment: t, curve: l, length: f }),
                        (h += f),
                        (t = t.getNext());
                } while (t && !t._intersection && t !== o);
                for (
                    var d = [0.5, 0.25, 0.75],
                        s = { winding: 0, quality: -1 },
                        _ = 1e-8,
                        g = 1 - _,
                        p = 0;
                    p < d.length && s.quality < 0.5;
                    p++
                )
                    for (var f = h * d[p], m = 0, y = a.length; m < y; m++) {
                        ...
                        if (f <= x) {
                            var l = w.curve,
                                b = l._path,
                                C = b._parent,
                                S = C instanceof E ? C : b,
                                k = u.clamp(l.getTimeAt(f), _, g),
                                I = l.getPointAtTime(k),
                                P = v(l.getTangentAtTime(k).y) < Math.SQRT1_2,
                                A =
                                    r.subtract &&
                                    n &&
                                    ((S === e &&
                                        n._getWinding(I, P, !0).winding) ||
                                        (S === n &&
                                            !e._getWinding(I, P, !0).winding))
                                        ? { winding: 0, quality: 1 }
                                        : c(I, i, P, !0);
            ...
            function d(t, e) {
                ...
                t.sort(function(t, e) {
                    ...
                    return r ^ s
                        ...
                        : !n ^ !i
                          ? n ? 1 : -1
                          : a !== o ? a._id - o._id : t._index - e._index;
                });
                for (var h = 0, u = t.length; h < u; h++) {
                    var l,
                        c,
                    ...
                    for (; _; ) {
                        ...
                        var M = d.getNext();
                        g.add(new A(d._point, f, M && d._handleOut)),
                            (d._visited = !0),
                            c.push(d),
                    ...
                    v &&
                        (p &&
                            (g.getFirstSegment().setHandleIn(f),
                            g.setClosed(p)),
                        0 !== g.getArea() && o.push(g));
                }
                return o;
            }
            var _ = Math.min,
            ...
            return {
                ...
                resolveCrossings: function() {
                    ...
                    return (
                        p > 1 && e
                            ? (n !== e && this.setChildren(n), (v = this))
                            : 1 !== p ||
                              e ||
                              (n[0] !== this &&
                                  this.setSegments(n[0].removeSegments()),
                              (v = this)),
                        v ||
                            ((v = new E(w.NO_INSERT)),
                            v.addChildren(n),
    ...
    var N = r.extend(
        ...
        B = r.extend({
            ...
            addCurve: function(t, e) {
                var n = t[t.length - 1];
                n.setHandleOut(e[1].subtract(e[0])),
                    t.push(new A(e[3], e[2].subtract(e[3])));
            },
            generateBezier: function(t, e, n, i, r) {
                for (
                    ...
                    var _ = n[f],
                        ...
                        b = r.normalize(y),
                        C = o[t + f]
                            .subtract(h.multiply(p + m))
                            .subtract(u.multiply(y + w));
                    (l[0][0] += x.dot(x)),
                        (l[0][1] += x.dot(b)),
                        (l[1][0] = l[0][1]),
                        (l[1][1] += b.dot(b)),
                ...
                var S,
                    k,
                    I = l[0][0] * l[1][1] - l[1][0] * l[0][1];
                if (a(I) > s) {
                    var P = l[0][0] * c[1] - l[1][0] * c[0],
                        A = c[0] * l[1][1] - c[1] * l[0][1];
                    (S = A / I), (k = P / I);
                } else {
                    var M = l[0][0] + l[0][1],
                        T = l[1][0] + l[1][1];
                ...
                return [
                    h,
                    h.add(z || i.normalize(S)),
                    u.add(O || r.normalize(k)),
                    u
                ];
            },
                ...
                function t(t) {
                    ...
                    if (r) {
                        ...
                        for (var s = 0; s < 3; s++) {
                            var o = r[s + 1];
                            i[s] =
                                parseInt(1 == o.length ? o + o : o, 16) / 255;
                        }
                                    ...
                                    (this["get" + a] = function() {
                                        ...
                                        (this["set" + a] = function(t) {
                                            this._type === e ||
                                                ...
                                                ((this._components = this._convert(
                                                    e
                                                )),
                                                (this._properties = i[e]),
                                                (this._type = e)),
                                                (this._components[n] = h.call(
                                                    this,
                                                    t
                                                )),
                                                this._changed();
                    ...
                    },
                    {
                        ...
                        initialize: function l(e) {
                            ...
                            if (((this._type = n || "rgb"), !a)) {
                                this._components = a = [];
                                for (
                                    var y = s[this._type], g = 0, v = y.length;
                                    g < v;
                                    g++
                                ) {
                        ...
                        toCanvasStyle: function(t, e) {
                            ...
                            if (
                                ...
                                n = t.createLinearGradient(a.x, a.y, o.x, o.y);
                ...
                "object" == typeof t &&
                    ...
                    (Array.isArray(t) && "number" != typeof t[0]
                        ...
                        : ("color" in t || "offset" in t || "rampPoint" in t) &&
                          ((i = t.color), (r = t.offset || t.rampPoint || 0))),
                    this.setColor(i),
                    this.setOffset(r);
            },
            clone: function() {
        ...
        V = r.extend(
            ...
            }(),
            {
                ...
                getLeading: function bt() {
                    var t = bt.base.call(this),
                        e = this.getFontSize();
                    return (
                        /pt|em|%|px/.test(e) &&
        ...
        U = new function() {
            ...
            return {
                ...
                isInView: function(t) {
                    return (
                        !U.isInvisible(t) &&
                        U.getViewportBounds(t).intersects(U.getBounds(t, !0))
                    );
                },
        ...
        H = {
            ...
            getPoint: function(t) {
                var e = t.targetTouches
                    ...
                    : t;
                return new c(
                    e.pageX || e.clientX + i.documentElement.scrollLeft,
                    e.pageY || e.clientY + i.documentElement.scrollTop
                );
            },
    ...
    H.requestAnimationFrame = new function() {
        ...
        var e,
            i = U.getPrefixed(n, "requestAnimationFrame"),
            r = !1,
            s = [];
        return function(n) {
            s.push(n),
                i ? r || (i(t), (r = !0)) : e || (e = setInterval(t, 1e3 / 60));
        };
    }();
    var Z = r.extend(
            s,
            {
                ...
                initialize: function Ct(t, e) {
                    ...
                    if (n && e) {
                        (this._id = e.getAttribute("id")),
                            null == this._id &&
                                e.setAttribute(
                                    "id",
                                    (this._id = "view-" + Ct._id++)
                                ),
                            H.add(e, this._viewEvents);
                        var h = "none";
                        if (
                            (U.setPrefixed(e.style, {
                                userDrag: h,
                                userSelect: h,
                                touchCallout: h,
                                contentZooming: h,
                    ...
                    (this._project = t),
                        ...
                        (this._element = e),
                        this._pixelRatio ||
                            (this._pixelRatio = (n && n.devicePixelRatio) || 1),
                        this._setElementSize(o.width, o.height),
                        (this._viewSize = o),
                        Ct._views.push(this),
                        (Ct._viewsById[this._id] = this),
                        ((this._matrix = new p())._owner = this),
                        Ct._focused || (Ct._focused = this),
                        (this._frameItems = {}),
                ...
                remove: function() {
                    ...
                    return (
                        ...
                        H.remove(this._element, this._viewEvents),
                        H.remove(n, this._windowEvents),
                    ...
                    if (!this._requested) {
                        ...
                        H.requestAnimationFrame(function() {
                            if (((t._requested = !1), t._animate)) {
                                t.requestUpdate();
                                var e = t._element;
                                (U.getPrefixed(i, "hidden") &&
                                    "true" !==
                                        a.getAttribute(e, "keepalive")) ||
                                    !U.isInView(e) ||
                                    t._handleFrame();
                            }
                ...
                getPixelSize: function(t) {
                    ...
                    if (n) {
                        ...
                        (s.style.fontSize = t),
                            r.appendChild(s),
                            (e = parseFloat(U.getStyles(s).fontSize)),
                            r.removeChild(s);
                    } else e = parseFloat(e);
                    return e;
                },
            ...
            r.each(
                ...
                },
                {
                    ...
                    setZoom: function(t) {
                        this.transform(
                            new p().scale(t / this.getZoom(), this.getCenter())
                        );
                    },
                    getRotation: function() {
                        var t = this._decompose();
                ...
                if (n) {
                    ...
                    var g = {},
                        v = {
                            mouseout: function(t) {
                                var e = Z._focused,
                                    n = H.getRelatedTarget(t);
                                if (e && (!n || "HTML" === n.nodeName)) {
                                    var i = H.getOffset(t, e._element),
                                        s = i.x,
                                        a = Math.abs,
                                        o = a(s),
                                        h = 1 << 25,
                                        u = o - h;
                                    (i.x = a(u) < o ? u * (s < 0 ? -1 : 1) : s),
                                        r(e, t, e.viewToProject(i));
                                }
                            },
                            scroll: e
                        };
                    ...
                    var p,
                        ...
                        I = !1,
                        P = !1,
                        A = { doubleclick: "click", mousedrag: "mousemove" },
                        M = !1,
                        T = {
                            mousedown: {
                                mousedown: 1,
                    ...
                    return {
                        ...
                        _handleMouseEvent: function(t, e, n) {
                            ...
                            if (
                                ...
                                o &&
                                    _ !== x &&
                                    (x && s(x, null, "mouseleave", e, n),
                                    _ && s(_, null, "mouseenter", e, n),
                                    (x = _)),
                                M ^ c &&
                                    (s(
                                        this,
                                ...
                                if ((a(this, _, t, e, n, m), v.down)) {
                                    if (
                                        ((k = _ === C && Date.now() - S < 300),
                                        (w = C = _),
                                        !P && _)
                                    ) {
                                        for (
                                            var A = _;
                                            A && !A.responds("mousedrag");
                            ...
                            (y = n),
                                g &&
                                    u &&
                                    (I = u._handleMouseEvent(t, e, n, v) || I),
                                ((I && !v.move) || (v.down && i("mouseup"))) &&
                                    e.preventDefault();
                        },
                        _handleKeyEvent: function(t, e, n, i) {
                            function r(r) {
                                r.responds(t) &&
                                    ((paper = a),
                                    r.emit(t, (s = s || new G(t, e, n, i))));
                            }
                            var s,
                                a = this._scope,
                                o = a.tool;
                            this.isVisible() &&
                                (r(this), o && o.responds(t) && r(o));
                        },
        ...
        W = Z.extend({
            ...
            initialize: function(t, e) {
                ...
                if (
                    ...
                    var o = n.devicePixelRatio || 1,
                        h = U.getPrefixed(s, "backingStorePixelRatio") || 1;
            ...
            getPixelSize: function It(t) {
                var e,
                    n = paper.agent;
                if (n && n.firefox) e = It.base.call(this, t);
                else {
                    var i = this._context,
                        r = i.font;
                    (i.font = t + " serif"),
                    ...
                    (e = /^U\+/.test(e)
                        ...
                        : /^Arrow[A-Z]/.test(e)
                          ...
                          : "Unidentified" === e
                            ...
                            : e),
                    o[e] || (e.length > 1 ? r.hyphenate(e) : e.toLowerCase())
                );
            }
            function e(t, n, i, a) {
                var o,
                ...
                if (
                    ((u[n] = t),
                    t ? (l[n] = i) : delete l[n],
                    n.length > 1 && (o = r.camelize(n)) in c)
                ) {
                    c[o] = t;
        ...
        Q = {
            request: function(e) {
                ...
                return (
                    ...
                    e.mimeType && n.overrideMimeType(e.mimeType),
                    (n.onload = function() {
                        var t = n.status;
                        0 === t || 200 === t
                            ? e.onLoad && e.onLoad.call(n, n.responseText)
                            : n.onerror();
                    }),
                    (n.onerror = function() {
                        var t = n.status,
                ...
                (this.process = function(t, e, n, i, r) {
                    ...
                    if (p || w[t])
                        n.save(),
                            ...
                            (n.globalAlpha = i),
                            p || (n.globalCompositeOperation = t),
                            n.drawImage(v, r.x, r.y),
                            n.restore();
                    else {
                        var m = y[t];
                        if (!m) return;
                        for (
                            var x = n.getImageData(r.x, r.y, v.width, v.height),
                                b = x.data,
                                C = e.getImageData(0, 0, v.width, v.height)
                                    .data,
                                S = 0,
                                k = b.length;
                            S < k;
        ...
        nt = new function() {
            ...
            function n(t, e, n) {
                for (var i in e) {
                    var r = e[i],
                        s = o[i];
                    "number" == typeof r && n && (r = n.number(r)),
                        s ? t.setAttributeNS(s, i, r) : t.setAttribute(i, r);
                }
                return t;
            }
        ...
        it = r.each(
            {
                ...
                strokeScaling: [
                    ...
                    function(t, e) {
                        return (
                            !e &&
                            (t instanceof O || t instanceof C || t instanceof j)
                        );
                    }
                ],
    ...
    return (
        new function() {
            function e(t, e, n) {
                ...
                if (!t.isIdentity()) {
                    ...
                    if (o) {
                        ...
                        s &&
                            !s.isZero() &&
                            h.push("translate(" + S.point(s) + ")"),
                            l && h.push("rotate(" + S.number(l) + ")"),
                            (u.isZero(c.x - 1) && u.isZero(c.y - 1)) ||
                                h.push("scale(" + S.point(c) + ")"),
                            f.x && h.push("skewX(" + S.number(f.x) + ")"),
                            f.y && h.push("skewY(" + S.number(f.y) + ")"),
                            (i.transform = h.join(" "));
                    } else
                        i.transform = "matrix(" + t.getValues().join(",") + ")";
                }
                return i;
            }
            function n(t, n) {
            ...
            function i(t, n) {
                ...
                return (
                    ...
                    (i.height = r.height),
                    (i.href =
                        (0 == n.embedImages && s && s.src) || t.toDataURL()),
                    nt.create("image", i, S)
                );
            }
            function s(t, n) {
            ...
            function c(t, n) {
                ...
                return (
                    s ||
                        ((s = nt.create("symbol", { viewBox: S.rectangle(o) })),
                        s.appendChild(b(a, n)),
                        m(r, s, "symbol")),
                    (i.href = "#" + s.id),
                    (i.x += o.x),
                ...
                if (!e) {
                    ...
                    for (var h = i._stops, u = 0, l = h.length; u < l; u++) {
                        var c = h[u],
                            ...
                            d = f.getAlpha(),
                            _ = c._offset;
                        (n = { offset: null == _ ? u / (l - 1) : _ }),
                            f && (n["stop-color"] = f.toCSS(!0)),
                            d < 1 && (n["stop-opacity"] = d),
                            e.appendChild(nt.create("stop", n, S));
                    }
                    m(t, e, "color");
                }
                return "url(#" + e.id + ")";
                ...
                return (
                    ...
                    r.each(it, function(e) {
                        ...
                        if (
                            ...
                            "style" === o
                                ? a.push(e.attribute + ": " + h)
                                : (i[e.attribute] =
                                      null == h
                                          ? "none"
                                          : "color" === o
                                            ? h.gradient ? f(h, t) : h.toCSS(!0)
                                            : "array" === o
                                              ? h.join(",")
                                              : "lookup" === o
                                                ? e.toSVG[h]
                    ...
                    a.length && (i.style = a.join(";")),
                    1 === i.opacity && delete i.opacity,
                    t._visible || (i.visibility = "hidden"),
                    nt.set(e, i, S)
                );
            }
            function v(t, e) {
            ...
            function x(e, n) {
                ...
                if (k) {
                    ...
                    for (var s in k.svgs)
                        r ||
                            (i || ((i = nt.create("svg")), i.appendChild(e)),
                            (r = i.insertBefore(
                                nt.create("defs"),
                                i.firstChild
                            ))),
                            r.appendChild(k.svgs[s]);
                    k = null;
                }
                return n.asString
                    ? new t.XMLSerializer().serializeToString(i)
                    : i;
            }
            function b(t, e, n) {
                var i = I[t._class],
                ...
                y.inject({
                    exportSVG: function(t) {
                        ...
                        var n = this._children,
                            ...
                            h =
                                "view" === s
                                    ? new g([0, 0], i.getViewSize())
                                    : "content" === s
                                      ? w._getBounds(n, o, { stroke: !0 }).rect
                        ...
                        h &&
                            ((u.width = h.width),
                            (u.height = h.height),
                            (h.x || h.y) && (u.viewBox = S.rectangle(h)));
                        var l = nt.create("svg", u, S),
                            c = l;
                        o &&
                            !o.isIdentity() &&
                            (c = l.appendChild(nt.create("g", e(o), S)));
                        for (var f = 0, d = n.length; f < d; f++)
                            c.appendChild(b(n[f], t, !0));
                        return x(l, t);
                    }
                });
        }(),
        new function() {
            function s(t, e, n, i, r) {
                ...
                return /%\s*$/.test(s)
                    ? a /
                          100 *
                          (r ? 1 : T[/x|^width/.test(e) ? "width" : "height"])
                    : a;
            }
            function a(t, e, n, i, r) {
                return (
                    (e = s(t, e || "x", !1, i, r)),
                    (n = s(t, n || "y", !1, i, r)),
                    !i || (null != e && null != n) ? new c(e, n) : null
                );
            }
            function o(t, e, n, i, r) {
                return (
                    (e = s(t, e || "width", !1, i, r)),
                    (n = s(t, n || "height", !1, i, r)),
                    !i || (null != e && null != n) ? new d(e, n) : null
                );
            }
            function h(t, e, n) {
                return "none" === t
                    ...
                    : "number" === e
                      ? parseFloat(t)
                      : "array" === e
                        ? t ? t.split(/[\s,]+/g).map(parseFloat) : []
                        : "color" === e ? P(t) || t : "lookup" === e ? n[t] : t;
            }
            function u(t, e, n, i) {
                var r = t.childNodes,
                    s = "clippath" === e,
            ...
            function l(t, e) {
                for (
                    ...
                    i.push(new c(parseFloat(n[r]), parseFloat(n[r + 1])));
                var a = new L(i);
            ...
            function _(t, e) {
                var n,
                    i = (s(t, "href", !0) || "").substring(1),
                    r = "radialgradient" === e;
                if (i)
                    (n = z[i].getGradient()),
                        n._radial ^ r && ((n = n.clone()), (n._radial = r));
                else {
                    for (
            ...
            function b(t, n, i) {
                ...
                if (!a) {
                    var o = r.camelize(n);
                    (a = t.style[o]),
                        a || i.node[o] === i.parent[o] || (a = i.node[o]);
                }
            ...
            function M(n, r, s) {
                function a(i) {
                    try {
                        ...
                        if (!a.nodeName)
                            throw ((a = null),
                            new Error("Unsupported SVG source: " + n));
                        (paper = h),
                            (u = A(a, r, !0)),
                            (r && r.insert === !1) || s._insertItem(e, u);
                        var l = r.onLoad;
                        l && l(u, i);
                    } catch (c) {
                        o(c);
                        ...
                        viewBox: function(t, e, n, i, r) {
                            ...
                            if (t instanceof x) {
                                var c = l ? l.divide(u.getSize()) : 1,
                                    a = new p()
                                        .scale(c)
                                        .translate(u.getPoint().negate());
                                s = t;
                            } else
                                t instanceof I &&
                                    (l && u.setSize(l), (s = t._item));
                            if (s) {
        ...
        (r.exports.PaperScript = function() {
            ...
            function h(r, s) {
                ...
                function u(t, e) {
                    ...
                    d.splice(s, 0, [n, e.length - i + n]),
                        (r = r.substring(0, n) + e + r.substring(i));
                }
                function l(t, e) {
                    if (t) {
                        for (var n in t)
                ...
                if (
                    ...
                    if (g.node) C -= 2;
                    else if (n && _ && !n.location.href.indexOf(_)) {
                    ...
                    var k = ["AA" + c(p ? 0 : C) + "A"];
                    (k.length = (r.match(b) || []).length + 1 + (p ? C : 0)),
                        (f = {
                            version: 3,
                            file: _,
                            names: [],
                ...
                return (
                    l(e(r, { ranges: !0, preserveParens: !0 })),
                    f &&
                        (p && (r = new Array(C + 1).join("\n") + r),
                        /^(inline|both)$/.test(m) &&
                            (r +=
            ...
            function u(t, e, n) {
                ...
                (t = p.code),
                    a({ __$__: s, $__: o, paper: e, view: l, tool: f }, !0),
                    a(e),
                    (_ = r
                        .each(
                            _,
                ...
                return (
                    ...
                    l &&
                        (x.onResize && l.setOnResize(x.onResize),
                        l.emit("resize", { size: l.size, delta: new c() }),
                        x.onFrame && l.setOnFrame(x.onFrame),
                        l.requestUpdate()),
                    p
                );
            }
            ...
            if (!v) {
                ...
                (v = m = y = {}),
                    (function(t, e) {
                        return "object" == typeof m && "object" == typeof y
                            ? e(m)
                            : "function" == typeof define && define.amd
                              ? define(["exports"], e)
                              : void e(t.acorn || (t.acorn = {}));
                    })(this, function(t) {
                        "use strict";
                        function e(t) {
                            ct = t || {};
                            for (var e in gt)
                                Object.prototype.hasOwnProperty.call(ct, e) ||
                                    (ct[e] = gt[e]);
                        ...
                        function o() {
                            var t = ct.onComment && ct.locations && new r(),
                                ...
                                i = ft.indexOf("*/", (pt += 2));
                            if (
                                (i === -1 && n(pt - 2, "Unterminated comment"),
                                (pt = i + 2),
                                ct.locations)
                            ) {
                                Xe.lastIndex = e;
                                for (var s; (s = Xe.exec(ft)) && s.index < pt; )
                                    ++kt, (It = s.index + s[0].length);
                            }
                            ct.onComment &&
                                ct.onComment(
                                    !0,
                        ...
                        function h() {
                            for (
                                var t = pt,
                                    e = ct.onComment && ct.locations && new r(),
                                    n = ft.charCodeAt((pt += 2));
                                pt < dt &&
                                10 !== n &&
                                13 !== n &&
                                8232 !== n &&
                        ...
                        function u() {
                            for (; pt < dt; ) {
                                ...
                                if (32 === t) ++pt;
                                    ...
                                    10 === e && ++pt,
                                        ct.locations && (++kt, (It = pt));
                                } else if (10 === t || 8232 === t || 8233 === t)
                                    ++pt, ct.locations && (++kt, (It = pt));
                                else if (t > 8 && t < 14) ++pt;
                                else if (47 === t) {
                        ...
                        function g(t) {
                            ...
                            return e === t
                                ? 45 == e &&
                                  62 == ft.charCodeAt(pt + 2) &&
                                  Je.test(ft.slice(At, pt))
                                  ? ((pt += 3), h(), u(), y())
                                  : w(ke, 2)
                                : 61 === e ? w(Se, 2) : w(Ne, 1);
                        }
                        function v(t) {
                            ...
                            return e === t
                                ? ((n =
                                      62 === t && 62 === ft.charCodeAt(pt + 2)
                                          ? 3
                                          : 2),
                                  61 === ft.charCodeAt(pt + n)
                                      ? w(Se, n + 1)
                                      : w(Ee, n))
                                : 33 == e &&
                                  60 == t &&
                                  45 == ft.charCodeAt(pt + 2) &&
                                  45 == ft.charCodeAt(pt + 3)
                                  ? ((pt += 4), h(), u(), y())
                                  : (61 === e &&
                                        (n =
                                            61 === ft.charCodeAt(pt + 2)
                                                ? 3
                                                : 2),
                                    w(Le, n));
                        }
                        function p(t) {
                            var e = ft.charCodeAt(pt + 1);
                            return 61 === e
                                ? w(Oe, 61 === ft.charCodeAt(pt + 2) ? 3 : 2)
                                : w(61 === t ? Ce : Ie, 1);
                        }
                        function m(t) {
                            switch (t) {
                        ...
                        function x() {
                            ...
                            try {
                                ...
                                u instanceof SyntaxError && n(r, u.message),
                                    n(u);
                            }
                            return a(Nt, h);
                        }
                        ...
                        function C() {
                            ...
                            return (
                                null == t &&
                                    n(mt + 2, "Expected hexadecimal number"),
                                Ke(ft.charCodeAt(pt)) &&
                                    n(pt, "Identifier directly after number"),
                                a(Et, t)
                            );
                        }
                        function S(t) {
                        ...
                        function k(t) {
                            ...
                            for (var e = ""; ; ) {
                                pt >= dt &&
                                    n(mt, "Unterminated string constant");
                        ...
                        function I(t) {
                            ...
                            return (
                                null === e &&
                                    n(mt, "Bad character escape sequence"),
                                e
                            );
                        }
                        function P() {
                            ...
                            for (var t, e = !0, i = pt; ; ) {
                                ...
                                if (Ye(r)) Fe && (t += ft.charAt(pt)), ++pt;
                                    ...
                                    a || n(pt - 1, "Invalid Unicode escape"),
                                        (e ? Ke(s) : Ye(s)) ||
                                            n(pt - 4, "Invalid Unicode escape"),
                                        (t += a);
                                }
                                e = !1;
                            }
                        ...
                        function O() {
                            (this.start = wt),
                                (this.end = null),
                                null !== _t && (this.source = _t);
                        }
                        function L() {
                            var t = new z();
                            return (
                                ct.locations && (t.loc = new O()),
                                ct.directSourceFile &&
                                    (t.sourceFile = ct.directSourceFile),
                                ct.ranges && (t.range = [mt, 0]),
                                t
                            );
                        }
                        function E(t) {
                        ...
                        function N(t, e) {
                            return (
                                (t.type = e),
                                (t.end = At),
                                ct.locations && (t.loc.end = Mt),
                                ct.ranges && (t.range[1] = At),
                                t
                            );
                        }
                        function B(t) {
                            ...
                            switch (t) {
                                ...
                                case Gt:
                                    ...
                                    if (bt === ee) {
                                        ...
                                        return (
                                            M(),
                                            J(a, !0),
                                            N(a, "VariableDeclaration"),
                                            1 === a.declarations.length && j(ue)
                                                ? G(e, a)
                                                : $(e, a)
                                        );
                                    }
                                ...
                                case Xt:
                                    return (
                                        ...
                                        (e.test = Z()),
                                        (e.consequent = H()),
                                        (e.alternate = j(Wt) ? H() : null),
                                        N(e, "IfStatement")
                                    );
                                case Kt:
                                    return (
                                        Tt ||
                                            ct.allowReturnOutsideFunction ||
                                            n(
                                                mt,
                                ...
                                case te:
                                    ...
                                    return (
                                        (e.guardedHandlers = Lt),
                                        (e.finalizer = j($t) ? W() : null),
                                        e.handler ||
                                            e.finalizer ||
                                            n(
                                                e.start,
                        ...
                        function J(t, e) {
                            for (t.declarations = [], t.kind = "var"; ; ) {
                                ...
                                if (
                                    ...
                                    (i.init = j(Ce) ? X(!0, e) : null),
                                    t.declarations.push(
                                        N(i, "VariableDeclarator")
                                    ),
                                    !j(pe))
                                )
                                    break;
                        ...
                        function X(t, e) {
                            ...
                            if (!t && bt === pe) {
                                var i = E(n);
                                for (i.expressions = [n]; j(pe); )
                                    i.expressions.push(K(e));
                        ...
                        function at() {
                            ...
                            for (t.properties = [], M(); !j(_e); ) {
                                if (e) e = !1;
                                    ...
                                    (R(pe), ct.allowTrailingCommas && j(_e))
                                )
                                    break;
                                var r,
                                    s = { key: ot() },
                                    ...
                                    (j(ye)
                                        ...
                                        : ct.ecmaVersion >= 5 &&
                                          ...
                                          ? ((a = i = !0),
                                            ...
                                            (s.value = ht(L(), !1)))
                                          : q(),
                                    "Identifier" === s.key.type && (Ot || i))
                                )
                                    for (
                                        var o = 0;
                                        o < t.properties.length;
                                        ++o
                                    ) {
                        ...
                        function ht(t, e) {
                            bt === jt ? (t.id = lt()) : e ? q() : (t.id = null),
                                (t.params = []);
                            var i = !0;
                            for (R(ge); !j(ve); )
                                i ? (i = !1) : R(pe), t.params.push(lt());
                            var r = Tt,
                                s = zt;
                            if (
                                ((Tt = !0),
                                ...
                                (Tt = r),
                                (zt = s),
                                Ot || (t.body.body.length && B(t.body.body[0])))
                            )
                                for (
                                    var a = t.id ? -1 : 0;
                                    a < t.params.length;
                        ...
                        function ut(t, e, n) {
                            for (var i = [], r = !0; !j(t); ) {
                                if (r) r = !1;
                                    ...
                                    (R(pe), e && ct.allowTrailingCommas && j(t))
                                )
                                    break;
                        ...
                        function lt(t) {
                            ...
                            return (
                                t &&
                                    "everywhere" == ct.forbidReserved &&
                                    (t = !1),
                                bt === jt
                                    ? (!t &&
                                          ((ct.forbidReserved &&
                                              (3 === ct.ecmaVersion ? De : Re)(
                                                  Ct
                                              )) ||
                                              (Ot && qe(Ct))) &&
                                          ft.slice(mt, yt).indexOf("\\") ==
                                              -1 &&
                                          n(
                                              mt,
                                              "The keyword '" +
                            ...
                            return (
                                (i.jumpTo = function(t, e) {
                                    if (((pt = t), ct.locations)) {
                                        ...
                                        for (
                                            var n;
                                            (n = Xe.exec(ft)) && n.index < t;

                                        )
                                            ++kt, (It = n.index + n[0].length);
                                    }
                                    (St = e), u();
                                }),
                                i
                        ...
                        var pt,
                            ...
                            Ft = { type: "eof" },
                            Dt = { keyword: "break" },
                            Rt = { keyword: "case", beforeExpr: !0 },
                            qt = { keyword: "catch" },
                            Vt = { keyword: "continue" },
                            Ut = { keyword: "debugger" },
                            Ht = { keyword: "default" },
                            Zt = { keyword: "do", isLoop: !0 },
                            Wt = { keyword: "else", beforeExpr: !0 },
                            $t = { keyword: "finally" },
                            Gt = { keyword: "for", isLoop: !0 },
                            Jt = { keyword: "function" },
                            Xt = { keyword: "if" },
                            Kt = { keyword: "return", beforeExpr: !0 },
                            Yt = { keyword: "switch" },
                            Qt = { keyword: "throw", beforeExpr: !0 },
                            te = { keyword: "try" },
                            ee = { keyword: "var" },
                            ne = { keyword: "while", isLoop: !0 },
                            ie = { keyword: "with" },
                            re = { keyword: "new", beforeExpr: !0 },
                            se = { keyword: "this" },
                            ae = { keyword: "null", atomValue: null },
                            oe = { keyword: "true", atomValue: !0 },
                            he = { keyword: "false", atomValue: !1 },
                            ue = { keyword: "in", binop: 7, beforeExpr: !0 },
                            le = {
                                break: Dt,
                                case: Rt,
                                catch: qt,
                            ...
                            ce = { type: "[", beforeExpr: !0 },
                            fe = { type: "]" },
                            de = { type: "{", beforeExpr: !0 },
                            _e = { type: "}" },
                            ge = { type: "(", beforeExpr: !0 },
                            ve = { type: ")" },
                            pe = { type: ",", beforeExpr: !0 },
                            me = { type: ";", beforeExpr: !0 },
                            ye = { type: ":", beforeExpr: !0 },
                            we = { type: "." },
                            xe = { type: "?", beforeExpr: !0 },
                            be = { binop: 10, beforeExpr: !0 },
                            Ce = { isAssign: !0, beforeExpr: !0 },
                            Se = { isAssign: !0, beforeExpr: !0 },
                            ke = { postfix: !0, prefix: !0, isUpdate: !0 },
                            Ie = { prefix: !0, beforeExpr: !0 },
                            Pe = { binop: 1, beforeExpr: !0 },
                            Ae = { binop: 2, beforeExpr: !0 },
                            Me = { binop: 3, beforeExpr: !0 },
                            Te = { binop: 4, beforeExpr: !0 },
                            ze = { binop: 5, beforeExpr: !0 },
                            Oe = { binop: 6, beforeExpr: !0 },
                            Le = { binop: 7, beforeExpr: !0 },
                            Ee = { binop: 8, beforeExpr: !0 },
                            Ne = { binop: 9, prefix: !0, beforeExpr: !0 },
                            Be = { binop: 10, beforeExpr: !0 };
                        t.tokTypes = {
                            bracketL: ce,
                            bracketR: fe,
                        ...
                        var Fe,
                            ...
                            Je = /[\n\r\u2028\u2029]/,
                            Xe = /\r\n|[\n\r\u2028\u2029]/g,
                            Ke = (t.isIdentifierStart = function(t) {
                                return t < 65
                                    ? 36 === t
                                    : t < 91 ||
                                          (t < 97
            ...
            return (
                ...
                n &&
                    ("complete" === i.readyState
                        ? setTimeout(f)
                        : H.add(n, { load: f })),
                { compile: h, execute: u, load: _, parse: e }
            );
        }.call(this)),
        ...
        paper.agent.node && require("./node/extend.js")(paper),
        "function" == typeof define && define.amd
            ? define("paper", paper)
